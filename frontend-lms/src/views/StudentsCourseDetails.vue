...
export default {
    ...
    created() {
        ...
        // You can fetch this information from the backend
    ...
    methods: {
        ...
        checkEnrollmentStatus() {
            // This function checks if the user is already enrolled in the course
            // You can implement this based on your backend logic
            // For demonstration purpose, setting a default value here
