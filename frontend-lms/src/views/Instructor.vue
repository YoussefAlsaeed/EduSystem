...
export default {
  ...
  methods: {
    ...
    searchCoursesByName() {
      const instructorId = this.$route.params.id;
      courseMicroSvc.get(`/course/searchCoursesByNameAndInstructor/${this.searchName}/${instructorId}`)
        .then(response => {
          this.courses = response.data;
        })
        .catch(error => {
    ...
    searchCoursesByCategory() {
      ...
      courseMicroSvc.get(`/course/searchCoursesByCategoryAndInstructor/${this.searchCategory}/${instructorId}`)
        .then(response => {
          this.courses = response.data;
        })
        .catch(error => {
